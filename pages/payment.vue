    ...
    <div class="container">
      <div class=" payment__container">
        <div class="car-type">
          ...
          <div class="car-type__price">{{currentCar.price | toUSD}}<span v-if="currentCar.сurrency_icon"> {{currentCar.сurrency_icon}}</span><span v-else> ₽</span></div>
        </div>
      ...
      <div class="payment__content">
        <transition name="fade" mode="out-in">
          ...
          <cash v-if="paymentType === 'cash'" />
          <card v-if="paymentType === 'card'" />
        </transition>
      </div>
    </div>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        tabs:[
          ...
          },
          {
            ...
            desc: this.$tc('main.utility.payment_methods'),
            name: 'card'
          },
        ],
      }
    ...
    methods: {
      toggleTab(name) {
	      this.$store.commit('setPaymentType', name.name)

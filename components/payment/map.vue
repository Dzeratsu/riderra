<template>
  ...
  <div class="wrap">
    ...
    <div class="details">
      <div class="details__title" @click="toggleOrder">{{$tc('main.utility.order_details')}}
      ...
      <div class="details__close" @click="showData">{{$tc('main.utility.change')}}</div>
      <div class="order__row" >
        <div class="order__title">{{$tc('main.utility.from')}}</div>
      ...
      <div class="order__row">
        <div class="order__title">{{$tc('main.utility.to')}}</div>
        <div class="order__desc">
      ...
      <div class="order__row">
        <div class="order__title">{{$tc('main.utility.date')}}</div>
        <div class="order__desc">
          {{ myData.date }}
      ...
      <div class="order__row">
        <div class="order__title">{{$tc('main.utility.time')}}</div>
        <div class="order__desc">
          {{ myData.time }}
      ...
      <div class="order__row">
        <div class="order__title">{{$tc('main.utility.type')}}</div>
        <div class="order__desc">
          {{ $tc(currentCar.title) }}
      ...
      <div class="order__row">
        <div class="order__title">{{$tc('main.utility.baggage')}}</div>
        <div class="order__desc">
          {{ myData.baggage }}
        </div>
      </div>
      <div class="order__row">
        <div class="order__title">{{$tc('main.utility.children_set')}}</div>
        <div class="order__desc">
          {{ Number(myData.kid_seats_3_6)+Number(myData.kid_seats_6_12) }}
        </div>
      </div>

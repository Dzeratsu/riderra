    ...
    <div class="field ">
      <div  class="field__rental policy ">
        <label class="policy__label field__title">
          <input v-model="hourlyRental" type="checkbox" class="policy__checkbox"><span>{{$tc('main.utility.hourlyrent')}}</span>
          <p class="subtitle">{{$tc('main.utility.15hoursswap')}}</p>
        </label>
    ...
    <div class="field ">
      <div  class="field__rental policy ">
        <label class="policy__label field__title wide">
          <input name="return_route" type="checkbox" class="policy__checkbox"><span>{{$tc('main.utility.return_trip')}}</span>
          <p class="subtitle">{{$tc('main.utility.details')}}</p>
        </label>
    ...
    data() {
      return {
        ...
        fields: [
          {
            data: 'iterate',
            title: this.$tc('main.utility.passange'),
            ...
            data: 'iterate',
            title: this.$tc('main.utility.baggage'),
            icon: '/img/baggage/baggage.svg',
            myVal: 0,
            name: 'baggage'
          }, {
            data: 'iterate',
            title: this.$tc('main.utility.animals'),
            icon: '/img/baggage/pet.svg',
            myVal: 0,
            name: 'pets'
          }, {
            data: 'list',
            title: this.$tc('main.utility.childrenlimit-03'),
          ...
          {
            data: 'list',
            title: this.$tc('main.utility.childrenlimit-36'),
            icon: '/img/baggage/kid.svg',
            myVal: '0',
            list: ['0',1,2],
            name: 'kid_seats_3_6'
            ...
            data: 'list',
            title: this.$tc('main.utility.childrenlimit-612'),
            icon: '/img/baggage/kid.svg',
            myVal: '0',
            list: ['0', 1, 2 ],
            name: 'kid_seats_6_12'
